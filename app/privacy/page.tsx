...
const policies: Policy[] = [
  {
    ...
    intro:
      "This notice explains how Bary (\"we\", \"us\", \"our\") processes personal data in line with the EU General Data Protection Regulation (GDPR).",
    sections: [
      {
      ...
      },
      {
        ...
        content: (
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Any optional details you choose to include in your message.</li>
          </ul>
        ),
      },
      {
      ...
      },
      {
        ...
        content: (
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>To improve how we handle inquiries (aggregated or anonymized insights only).</li>
          </ul>
        ),
      },
      {
        ...
        content: (
          <p>
            We share data only with service providers who support our communications and hosting (for example, email and cloud
            services). They act under our instructions and appropriate safeguards. We do not sell personal data.
          </p>
        ),
      },
      {
  ...
  },
  {
    ...
    intro:
      "Šiame pranešime paaiškinama, kaip Bary (\"mes\", \"mums\", \"mūsų\") tvarko asmens duomenis pagal ES Bendrąjį duomenų apsaugos reglamentą (BDAR).",
    sections: [
      {
      ...
      },
      {
        ...
        content: (
          <p>
            Duomenis teikiame tik paslaugų teikėjams, kurie padeda mums užtikrinti komunikaciją ir talpinimą (pavyzdžiui, el.
            pašto ir debesijos paslaugos). Jie duomenis tvarko pagal mūsų nurodymus ir taiko tinkamas apsaugos priemones. Mes
            neparduodame asmens duomenų.
          </p>
        ),
      },
      {
        ...
        content: (
          <p>
            ...
            veiksmų nereikia, duomenys ištrinami arba anonimizuojami per 12 mėnesių, nebent ilgesnį saugojimą nustato teisės
            aktai.
          </p>
        ),
      },
