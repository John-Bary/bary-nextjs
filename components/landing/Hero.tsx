      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Strategic Consulting & Creative Agency</span>
          </motion.div>
          ...
          >
            We Turn Strategy
            <br />
            <span className="gradient-text glow-text">Into Results</span>
          </motion.h1>
          ...
          >
            Business consulting and creative services that drive measurable growth.
            We help companies scale through strategic planning, brand development, and digital innovation.
          </motion.p>
