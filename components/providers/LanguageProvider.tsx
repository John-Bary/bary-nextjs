        ...
        portfolio: {
            ...
            projects: [
                ...
                },
                {
                    ...
                    gradient: "from-[hsl(var(--surface-2))] to-[hsl(var(--primary))]",
                ...
                },
                {
                    ...
                    gradient: "from-[hsl(var(--surface))] to-[hsl(var(--primary-hover))]",
                    badgeVariant: "primary" as const,
                },
                {
                    ...
                    gradient: "from-[hsl(var(--primary))] to-[hsl(var(--surface-2))]",
                    badgeVariant: "muted" as const,
                },
            ],
        },
