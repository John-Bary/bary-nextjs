  ...
  en: {
    ...
    bookCall: {
      ...
      outline: {
        ...
        footer: "Prefer email? Reach us at hello@bary.lt — we'll reply within one business day.",
      },
    },
    faq: {
      badge: "FAQ",
  ...
  lt: {
    ...
    bookCall: {
      ...
      outline: {
        ...
        footer: "Patogiau el. paštu? Rašykite hello@bary.lt — atsakysime per 1 darbo dieną.",
      },
    },
    faq: {
      badge: "DUK",
